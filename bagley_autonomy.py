...
async def _decide(guild, lines: list[str], bot_in_voice: bool) -> dict | None:
    ...
    prompt = (
        ...
        "🖼️ ถ้าในข้อความล่าสุดมีบรรทัดที่บอกว่ามีคนแนบ/ส่งรูปภาพมา (จะมีวงเล็บ [แนบรูปภาพ...] หรือ [ส่งรูปภาพ...] "
        "พร้อมคำบรรยายว่าในรูปคืออะไร) ให้ถือว่านั่นคือสิ่งที่เห็นในห้องด้วย เอามาใช้ประกอบการตัดสินใจ 'ชวนคุย' ได้เลย "
        "เช่น ทักทาย/แซว/ถามต่อเกี่ยวกับรูปนั้นอย่างเป็นธรรมชาติ เหมือนคุณเห็นรูปนั้นด้วยตาตัวเองในห้อง\n"
